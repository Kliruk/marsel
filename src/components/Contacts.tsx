...
import {INSTAGRAM, STAR_DELAY_DEFAULT, TELEGRAM} from "@/constants/constants";
  ...
  return (
    <div className={styles.main}>
      <div className={styles.uniqueOffer}>
          <CustomHeader headerType={"h2"} isYMoves={true} color="var(--color-white)" >отримайте</CustomHeader>
          <CustomHeader headerType={"h2"} isYMoves={false} color="var(--color-white)" >УНIКАЛЬНУ</CustomHeader>
          <CustomHeader headerType={"h2"} isYMoves={true} color="var(--color-white)" >ПРопозицiю</CustomHeader>
